...
function ToolApprovalCard({ toolCall, onApprove, onDeny }) {
    ...
    const toolLabel = toolCall.name === 'execute_python' ? 'python'
        : toolCall.name === 'execute_bash' ? 'bash'
            : 'opencern';
    return (_jsxs(Box, { flexDirection: "column", marginY: 1, paddingX: 1, borderStyle: "round", borderColor: "yellow", children: [_jsxs(Box, { flexDirection: "row", marginBottom: 1, gap: 1, children: [_jsx(Text, { color: "black", backgroundColor: "yellow", bold: true, children: " \u2699 EXECUTING " }), _jsxs(Text, { color: "yellow", children: [" ", toolLabel, " "] })] }), toolCall.resourceWarning && (_jsx(Box, { marginBottom: 1, children: _jsxs(Text, { color: "yellow", dimColor: true, children: ["\u26A0 ", toolCall.resourceWarning] }) })), _jsx(Box, { flexDirection: "column", marginY: 0, paddingLeft: 1, children: (toolCall.displayCode || '').split('\n').map((line, i) => (_jsx(Text, { color: "gray", children: line }, i))) }), _jsx(Box, { gap: 2, marginTop: 1, borderStyle: "single", borderTop: true, borderColor: "gray", children: _jsxs(Text, { color: "gray", dimColor: true, children: ["Press ", _jsx(Text, { bold: true, color: "white", children: "Enter" }), " to run or ", _jsx(Text, { bold: true, color: "white", children: "Esc" }), " to skip"] }) })] }));
}
